        ...
        <footer className = "footer" id = "footer">
            <div className = "footer__content">
                ...
                <div className = "contacts"> 
                    <a aria-label="Link to LinkedIn page" target = "_blank" href="https://www.linkedin.com/in/max-spizhovyi" rel="noreferrer">
                    ...
                    <a aria-label="Link to Github page" target = "_blank" href="https://github.com/SpizhovyiMaxDev" rel="noreferrer">
